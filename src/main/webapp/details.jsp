...
<html>
    <head>
    <style><%@include file="./css/style_details.css"%></style>
...
<header class="header">
	...
	<img class="card_image" alt="" src="${requestScope.book.urlImage}"> 
		<div class="container_info">
			...
			<p>El autor del libro es: <b>${requestScope.book.author}</b> </p>
			<p>La editorial de ${requestScope.book.title} es: <b>${requestScope.book.editorial}</b></p>
			<p>El libro fue publicado el <b>${requestScope.book.pubDate}</b> </p>
			<p>Total de páginas: <b>${requestScope.book.pagesNumber}</b></p>
			<p>El número identificativo de este libro es: <b>${requestScope.book.serialNumber}</b></p>
